...
func _ready():
	...
	display_text("Creepy guy challenges you to a fight, You accept it!")
	#show text 
...
func enemy_turn():
	...
	if is_defending == true:
		...
		var random_enemy_atk = random_enemy_attack_num.randi_range(0, 2)
		# player lose health 
...
func _on_Run_pressed():
	display_text("Successfully got away!... Like a coward :(")
	yield(self, "text_box_closed")
	get_tree().quit()
